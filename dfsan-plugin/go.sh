...
https://ftp.gnu.org/gnu/tar/tar-1.28.tar.gz tar-1.28.tar.gz any
...
#https://ftp.gnu.org/gnu/wget/wget-1.19.5.tar.gz  wget-1.19.5.tar.gz b39212abe1a73f2b28f4c6cb223c738559caac91d6e416a6d91d4b9d55c9faee
